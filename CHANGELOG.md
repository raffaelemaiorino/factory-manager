...
- `TODO.md`: follow-up noti (build macOS non testata, nessun target `.deb`, nessuna matrice CI, nessun test automatico) così restano tracciati invece di essere dimenticati.
